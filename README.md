...
> **Note:** You may see the transformation logs appear twice during agent initialization.  
> This is normal behavior - LangChain internally calls the tool binding process multiple times
> when constructing the agent graph.  
> The transformation only occurs during setup, not during message processing,
